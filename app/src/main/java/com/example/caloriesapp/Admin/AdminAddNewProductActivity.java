...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private String CategoryName, Description, Calories, Pname, saveCurrentDate, saveCurrentTime;
    private Button AddNewProductButton;
    private ImageView InputProductImage;
    private EditText InputProductName, InputProductDescription, InputProductCalories;
    ...
    private void ValidateProductData()
    {
        ...
        Calories = InputProductCalories.getText().toString();
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        productMap.put("calories", Calories);
