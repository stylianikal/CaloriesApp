...
public class AdminMaintainProductsActivity extends AppCompatActivity
{
    ...
    private EditText name, calories, description;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        calories = findViewById(R.id.product_calories_maintain);
    ...
    private void applyChanges()
    {
        ...
        else  if (pCalories.equals(""))
        {
            Toast.makeText(this, "Write down Product Calories", Toast.LENGTH_SHORT).show();
        }
        ...
        else
        {
            ...
            productMap.put("calories", pCalories);
        ...
        productRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                  ...
                  String pCalories = dataSnapshot.child("calories").getValue().toString();
                  String pDescription = dataSnapshot.child("description").getValue().toString();
                  String pImage = dataSnapshot.child("image").getValue().toString();

                    name.setText(pName);
                    calories.setText(pCalories);
